...
class Assess2Item1 extends StatefulWidget {
  ...
  Assess2Item1({Key? key, required this.activityCode}) : super(key: key);

  @override
  _Assess2Item1State createState() => _Assess2Item1State();
}
...
class _Assess2Item1State extends State<Assess2Item1> {
  ...
  Future<void> sendAudio() async {
    ...
    try {
      ...
      await prefs.setString('User1', _pathToAudio); // Save the file path
      await prefs.setString('ItemCode1', _itemcode); // Save the item code
