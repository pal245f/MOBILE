...
class Assess2Item3 extends StatefulWidget {
  ...
  Assess2Item3({Key? key, required this.activityCode}) : super(key: key);

  @override
  _Assess2Item3State createState() => _Assess2Item3State();
}
...
class _Assess2Item3State extends State<Assess2Item3> {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          _itemcode = itemCode.isNotEmpty ? itemCode[2]['ItemCode'] : 'No Code';

          final word = data['Items'] as List<dynamic>;
          _getword = word.isNotEmpty ? itemCode[2]['Word'] : 'No Word';
  ...
  Future<void> startRecording() async {
    if (await Permission.microphone.isGranted) {
      ...
      _pathToAudio =
          path.join(directory.path, 'temp_${widget.activityCode}_item3.wav');
  ...
  Future<void> sendAudio() async {
    ...
    try {
      ...
      await prefs.setString('User3', _pathToAudio); // Save the file path
      await prefs.setString('ItemCode3', _itemcode); // Save the item code
