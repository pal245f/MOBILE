...
class Assess2Item4 extends StatefulWidget {
  ...
  Assess2Item4({Key? key, required this.activityCode}) : super(key: key);

  @override
  _Assess2Item4State createState() => _Assess2Item4State();
}
...
class _Assess2Item4State extends State<Assess2Item4> {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          _itemcode = itemCode.isNotEmpty ? itemCode[3]['ItemCode'] : 'No Code';

          final word = data['Items'] as List<dynamic>;
          _getword = word.isNotEmpty ? itemCode[3]['Word'] : 'No Word';
  ...
  Future<void> startRecording() async {
    if (await Permission.microphone.isGranted) {
      ...
      _pathToAudio =
          path.join(directory.path, 'temp_${widget.activityCode}_item4.wav');
  ...
  Future<void> sendAudio() async {
    ...
    try {
      ...
      await prefs.setString('User4', _pathToAudio); // Save the file path
      await prefs.setString('ItemCode4', _itemcode); // Save the item code
