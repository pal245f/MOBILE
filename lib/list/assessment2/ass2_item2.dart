...
class Assess2Item2 extends StatefulWidget {
  ...
  Assess2Item2({Key? key, required this.activityCode}) : super(key: key);

  @override
  _Assess2Item2State createState() => _Assess2Item2State();
}
...
class _Assess2Item2State extends State<Assess2Item2> {
  ...
  Future<void> sendAudio() async {
    ...
    try {
      ...
      await prefs.setString('User2', _pathToAudio); // Save the file path
      await prefs.setString('ItemCode2', _itemcode); // Save the item code
