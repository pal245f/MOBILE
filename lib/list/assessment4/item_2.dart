...
class Assessment4Item2 extends StatefulWidget {
  ...
  @override
  _Assessment4Item2State createState() => _Assessment4Item2State();
}

class _Assessment4Item2State extends State<Assessment4Item2> {
  String? _questions;
  String? _answer;
      ...
      if (questionResponse.statusCode == 200) {
        ...
        if (questionData.containsKey('Questions') &&
          ...
          if (questionList.isNotEmpty &&
              questionList[1] is Map<String, dynamic>) {
            setState(() {
              _questions =
                  questionList[1]['Question'] ?? 'No question available';
              _answer = questionList[1]['Answer'] ?? 'No answer available';
            });
          } else {
  ...
  void _submitAnswers() async {
    ...
    await prefs.setInt('scoreItem2', _score);
