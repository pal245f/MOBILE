...
class Assess1Item8 extends StatefulWidget {
  final String activityCode;

  Assess1Item8({Key? key, required this.activityCode}) : super(key: key);

  @override
  _Assess1Item8State createState() => _Assess1Item8State();
}

class _Assess1Item8State extends State<Assess1Item8> {
  ...
  Future<void> sendAudio() async {
    ...
    try {
      ...
      await prefs.setString('User8', _pathToAudio); 
      await prefs.setString('ItemCode8', _itemcode);
      _isAudioSent = true; 
