...
class Assess1Item4 extends StatefulWidget {
  ...
  Assess1Item4({Key? key, required this.activityCode}) : super(key: key);

  @override
  _Assess1Item4State createState() => _Assess1Item4State();
}
...
class _Assess1Item4State extends State<Assess1Item4> {
  ...
  Future<void> sendAudio() async {
    ...
    try {
      ...
      await prefs.setString('User4', _pathToAudio); 
      await prefs.setString('ItemCode4', _itemcode);
      _isAudioSent = true; 
