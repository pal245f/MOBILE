...
class Assess1Item10 extends StatefulWidget {
  final String activityCode;

  Assess1Item10({Key? key, required this.activityCode}) : super(key: key);

  @override
  _Assess1Item10State createState() => _Assess1Item10State();
}

class _Assess1Item10State extends State<Assess1Item10> {
