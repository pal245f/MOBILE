...
class Assess1Item6 extends StatefulWidget {
  final String activityCode;

  Assess1Item6({Key? key, required this.activityCode}) : super(key: key);

  @override
  _Assess1Item6State createState() => _Assess1Item6State();
}

class _Assess1Item6State extends State<Assess1Item6> {
  ...
  Future<void> sendAudio() async {
    ...
    try {
      ...
      await prefs.setString('User6', _pathToAudio); 
      await prefs.setString('ItemCode6', _itemcode);
      _isAudioSent = true; 
