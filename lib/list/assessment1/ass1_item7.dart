...
class Assess1Item7 extends StatefulWidget {
  final String activityCode;

  Assess1Item7({Key? key, required this.activityCode}) : super(key: key);

  @override
  _Assess1Item7State createState() => _Assess1Item7State();
}

class _Assess1Item7State extends State<Assess1Item7> {
  ...
  Future<void> sendAudio() async {
    ...
    try {
      ...
      await prefs.setString('User7', _pathToAudio); 
      await prefs.setString('ItemCode7', _itemcode);
      _isAudioSent = true; 
