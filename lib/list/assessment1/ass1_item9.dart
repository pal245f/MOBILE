...
class Assess1Item9 extends StatefulWidget {
  final String activityCode;

  Assess1Item9({Key? key, required this.activityCode}) : super(key: key);

  @override
  _Assess1Item9State createState() => _Assess1Item9State();
}

class _Assess1Item9State extends State<Assess1Item9> {
  ...
  Future<void> sendAudio() async {
    ...
    try {
      ...
      await prefs.setString('User9', _pathToAudio); 
      await prefs.setString('ItemCode9', _itemcode);
      _isAudioSent = true; 
