...
class Assess1Item1 extends StatefulWidget {
  ...
  Assess1Item1({Key? key, required this.activityCode}) : super(key: key);

  @override
  _Assess1Item1State createState() => _Assess1Item1State();
}
...
class _Assess1Item1State extends State<Assess1Item1> {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          _itemcode = itemCode.isNotEmpty ? itemCode[0]['ItemCode'] : 'No Code';

          final word = data['Items'] as List<dynamic>;
          _getword = word.isNotEmpty ? itemCode[0]['Word'] : 'No Word';
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            Container(
              height: 490.h, // Responsive height
              width: 370.w, // Responsive width
            ...
            MaterialButton(
              ...
              padding: EdgeInsets.symmetric(vertical: 20.h, horizontal: 130.w), // Responsive padding
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(20.r), // Responsive radius
              ),
              child: Text(
  ...
  ElevatedButton _buildElevatedButton({
    ...
    return ElevatedButton.icon(
      style: ElevatedButton.styleFrom(
        ...
        minimumSize: Size(125.w, 40.h), // Responsive size
        backgroundColor: Colors.blue.shade400,
      ),
      onPressed: onPressFunc,
      icon: Icon(icon, color: iconColor, size: 25.sp), // Responsive icon size
      label: Text(label, style: TextStyle(fontSize: 18.sp, color: Colors.white)), // Responsive font size
    );
  }
  ...
  Future<void> startRecording() async {
    if (await Permission.microphone.isGranted) {
      ...
      _pathToAudio =
          path.join(directory.path, 'temp_${widget.activityCode}_item1.wav');
  ...
  Future<void> sendAudio() async {
    ...
    try {
      ...
      await prefs.setString('User1', _pathToAudio);
      await prefs.setString('ItemCode1', _itemcode);
      _isAudioSent = true;
