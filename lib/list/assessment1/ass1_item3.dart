...
class Assess1Item3 extends StatefulWidget {
  ...
  Assess1Item3({Key? key, required this.activityCode}) : super(key: key);

  @override
  _Assess1Item3State createState() => _Assess1Item3State();
}
...
class _Assess1Item3State extends State<Assess1Item3> {
  ...
  Future<void> sendAudio() async {
    ...
    try {
      ...
      await prefs.setString('User3', _pathToAudio); 
      await prefs.setString('ItemCode3', _itemcode);
      _isAudioSent = true; 
