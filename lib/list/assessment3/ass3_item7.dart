...
class Assess3Item7 extends StatefulWidget {
  final String activityCode;

  Assess3Item7({Key? key, required this.activityCode}) : super(key: key);

  @override
  _Assess3Item7State createState() => _Assess3Item7State();
}

class _Assess3Item7State extends State<Assess3Item7> {
