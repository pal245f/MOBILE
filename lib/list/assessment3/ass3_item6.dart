...
class Assess3Item6 extends StatefulWidget {
  final String activityCode;

  Assess3Item6({Key? key, required this.activityCode}) : super(key: key);

  @override
  _Assess3Item6State createState() => _Assess3Item6State();
}

class _Assess3Item6State extends State<Assess3Item6> {
